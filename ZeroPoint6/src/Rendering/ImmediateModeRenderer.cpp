...
namespace zp
{
        ...
        , memoryLabel( memoryLabel )
    {
        ...
        GraphicsBufferDesc vertexBufferDesc {
            ...
            .usageFlags = ZP_GRAPHICS_BUFFER_USAGE_VERTEX_BUFFER | ZP_GRAPHICS_BUFFER_USAGE_TRANSFER_DST,
        ...
        GraphicsBufferDesc indexBufferDesc {
            ...
            .usageFlags = ZP_GRAPHICS_BUFFER_USAGE_INDEX_BUFFER | ZP_GRAPHICS_BUFFER_USAGE_TRANSFER_DST,
            .memoryPropertyFlags = ZP_MEMORY_PROPERTY_HOST_VISIBLE,
        };
